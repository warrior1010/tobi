...
<html class="loading">
  <head>
    ...
    <title>Chuza Checker</title></title>
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>SK BASED BY CHUZA<br<Chuza</br></strong></h4>
					<textarea rows="14" class="form-control text-center form-checker mb-2" placeholder="𝙋𝙐𝙏 𝘾𝘾 𝙃𝙀𝙍𝙀"></textarea>	
					
					<textarea rows="1" class="form-control text-center" style="width:100%; float: left ;"  id="sk" placeholder="Sk Here"></textarea></br>
								
					
					          <select name="gate" id="gate" class="form-control" style="margin-top: 0px;">
					<option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1.php">CCN 𝗖𝗛𝗔𝗥𝗚𝗘𝗗 $𝟭</option>
...
<li><a href=http://t.me/Chuza79>Dev</a></li>
<li><a href=http://t.me/Chuza79>CHANNEL</a></li>
</ul> 
